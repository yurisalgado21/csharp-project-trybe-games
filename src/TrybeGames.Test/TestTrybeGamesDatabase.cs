...
public class TestTrybeGamesDatabase
{
    ...
    {
        // Arrange
        var Games = databaseEntry.Games;
        var GameStudios = databaseEntry.GameStudios;
        var Players = databaseEntry.Players;
        // AcT
        var result = databaseEntry.GetGamesPlayedBy(Players.Find(player => player.Id == playerIdEntry)!);
        // Assert
