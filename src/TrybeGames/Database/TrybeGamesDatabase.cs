...
public class TrybeGamesDatabase
{
    ...
    {
        // Implementar
        var allDifferentGameTypes = from game in Games
                                    select game.GameType;
        
        return allDifferentGameTypes.Distinct().ToList();
    }
    ...
    {
        // Implementar
        var studiosWithGamesWithPlayers =
        ...
        return studiosWithGamesWithPlayers.ToList();
    }
